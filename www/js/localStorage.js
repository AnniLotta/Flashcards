            ...
            if (cardJson.deck === currentDeckId) {
                ...
                result += `
                    <div class="card block block-strong inset display-flex row">
                        ...
                        <div class="col-30">
                            <div class="row">
                                <a class="get-card-details col-50" href="/edit-card/" data-card-id="${"card" + i}"><i class="icon f7-icons float-right margin-right padding-top">pencil</i></a>
                                <a class="delete-card col-50" data-card-id="${"card" + i}"><i class="icon f7-icons color-red float-right margin-right padding-top">bin_xmark_fill</i></a>
                            </div>
                        </div>
                    </div>`;
            }
